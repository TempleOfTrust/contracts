...
Mostly copied from https://github.com/kivanov82/ERC20Box/blob/master/contracts/TradeableERC721Token.sol
...
contract TradeableERC721Token is ERC721Full, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, address _proxyRegistryAddress, string memory _baseTokenURI) ERC721Full(_name, _symbol) public {
